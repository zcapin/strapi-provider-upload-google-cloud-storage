          ...
          checkBucket(GCS, config.bucketName, config.bucketLocation)
            ...
            .then((image) => {
              if (!!image) {
                ...
                return Promise.all([
                  new Promise((resolve) => {
                    const imageLG = image.contain(1024, 768);
                  ...
                  new Promise((resolve) => {
                    const imageMD = image.contain(640, 480);
                  ...
                  new Promise((resolve) => {
                    const imageSM = image.contain(320, 240);
                  ...
                  new Promise((resolve) => {
                    const imageThumb = image.contain(150, 150);
            ...
            .then((image) => {
              if (image) {
                const originalImage = image.contain(1024, 1024);
