                  ...
                  new Promise((resolve) => {
                    ...
                    const imageLG =
                      ...
                      (newImage.bitmap.width > 1024 ||
                        ...
                        ? newImage.contain(1024, 768).quality(90)
                        : newImage.quality(90);
                  ...
                  new Promise((resolve) => {
                    ...
                    const imageMD =
                      ...
                      (newImage.bitmap.width > 640 ||
                        ...
                        ? newImage.contain(640, 480).quality(90)
                        : newImage.quality(90);
                  ...
                  new Promise((resolve) => {
                    ...
                    const imageSM =
                      ...
                      (newImage.bitmap.width > 320 ||
                        ...
                        ? newImage.contain(320, 240).quality(90)
                        : newImage.quality(90);
                  ...
                  new Promise((resolve) => {
                    ...
                    const imageThumb =
                      ...
                      (newImage.bitmap.width > 100 ||
                        ...
                        ? newImage.contain(100, 100).quality(90)
                        : newImage.quality(90);
              ...
              if (image) {
                ...
                const originalImage =
                  ...
                  (newImage.bitmap.width > 1024 ||
                    ...
                    ? newImage.contain(1024, 1024).quality(90)
                    : newImage.quality(90);
                const mimeType = getMimeType(file.ext);
